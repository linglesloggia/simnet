...
class ChannelEnvironment(ChannelEnvironment):
    ...
    def __init__(self):
        '''Constructor.
        '''
        print("--- 5G 3GPP Indoor ChannelEnvironment created")
        ...
        self.scf=  sc.Scenario3GPPInDoor(self.fcGHz, posx_min,posx_max, posy_min, posy_max, grid_number, BS_pos, Ptx_db,True,self.LOS)
