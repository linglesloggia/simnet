...
#-*- coding: utf-8 -*-
#
# prioqueue_ev : tests on priority queues, rounds controlled by specific event
#    a modified version of prioqueue, which task events define time scale
...
This version uses an event to define the time scale.
'''
